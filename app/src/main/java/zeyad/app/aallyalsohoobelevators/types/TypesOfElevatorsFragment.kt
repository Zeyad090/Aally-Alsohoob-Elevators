 ...
 * Use the [TypesOfElevatorsFragment.newInstance] factory method to
...
class TypesOfElevatorsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TypesOfElevatorsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TypesOfElevatorsFragment().apply {
